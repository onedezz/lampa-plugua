(function () {
     ...
     * Developed by: Syvyj
     * Extended with Crunchyroll support
     * Version: 1.3.0
     * Description: Unified studio collections for Lampa (Netflix, HBO, Disney+, Crunchyroll, etc.)
     */
    ...
    var SERVICE_CONFIGS = {
        ...
        'crunchyroll': {
            title: 'Crunchyroll',
            icon: '<svg viewBox="0 0 24 24" fill="#F47521"><path d="M12 2A10 10 0 1 0 22 12 10 10 0 0 0 12 2zm0 18a8 8 0 1 1 8-8 8 8 0 0 1-8 8zm-2.5-13a5.5 5.5 0 1 0 5.5 5.5A5.5 5.5 0 0 0 9.5 7zm0 8.5a3 3 0 1 1 3-3 3 3 0 0 1-3 3z"/></svg>',
            categories: [
                { "title": "Нові аніме-серіали", "url": "discover/tv", "params": { "with_networks": "1112", "sort_by": "first_air_date.desc", "first_air_date.lte": "{current_date}", "vote_count.gte": "5" } },
                { "title": "В тренді на Crunchyroll", "url": "discover/tv", "params": { "with_networks": "1112", "sort_by": "popularity.desc" } },
                { "title": "Аніме-фільми", "url": "discover/movie", "params": { "with_keywords": "210024", "with_genres": "16", "sort_by": "popularity.desc" } },
                { "title": "Екшн та Сьонен", "url": "discover/tv", "params": { "with_networks": "1112", "with_genres": "10759,16", "sort_by": "popularity.desc" } },
                { "title": "Фантастика та Ісекай", "url": "discover/tv", "params": { "with_networks": "1112", "with_genres": "10765", "sort_by": "popularity.desc" } },
                { "title": "Романтика та Драма", "url": "discover/tv", "params": { "with_networks": "1112", "with_genres": "18,35", "sort_by": "popularity.desc" } },
                { "title": "Золота колекція (Рейтинг 8.0+)", "url": "discover/tv", "params": { "with_networks": "1112", "vote_average.gte": "8.0", "vote_count.gte": "100", "sort_by": "vote_average.desc" } }
            ]
        },
        'syfy': {
            title: 'Syfy',
