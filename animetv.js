(function () {
    ...
    /**
     * ANIME TV SERIES - TRAKT.TV ENGINE (WATCHED ENDPOINT OPTIMIZED)
     * Uses /shows/watched/yearly for Genre rows to ensure full & popular lists
     */
    ...
    var TRAKT_CONFIG = {
        ...
        categories: [
            ...
            { title: "⭐ Популярне аніме", url: "https://api.trakt.tv/shows/popular?genres=anime&countries=jp,kr&limit=100" },
            { title: "📈 Тренди", url: "https://api.trakt.tv/shows/trending?genres=anime&countries=jp,kr&limit=100" },

            // --- 2. ДЕСЯТИЛІТТЯ (ЗА ПОПУЛЯРНІСТЮ) ---
            { title: "⚡ Сучасність 2020-х", url: "https://api.trakt.tv/shows/popular?genres=anime&countries=jp,kr&years=2020-" + currentYear + "&limit=100" },
            { title: "💎 Ера 2010-х", url: "https://api.trakt.tv/shows/popular?genres=anime&countries=jp,kr&years=2010-2019&limit=100" },
            { title: "💿 Культові 2000-ні", url: "https://api.trakt.tv/shows/popular?genres=anime&countries=jp,kr&years=2000-2009&limit=100" },
            ...
            // --- 3. ОКРЕМІ ЖАНРИ (ТОП ПЕРЕГЛЯДІВ ЗА ОСТАННІЙ 1 РІК - WATCHED/YEARLY) ---
            { title: "⚔️ Бойовики (За рік)", url: "https://api.trakt.tv/shows/watched/yearly?genres=anime,action&countries=jp,kr&years=" + yearRangeOneYear + "&limit=100" },
            { title: "🤠 Пригоди (За рік)", url: "https://api.trakt.tv/shows/watched/yearly?genres=anime,adventure&countries=jp,kr&years=" + yearRangeOneYear + "&limit=100" },
            { title: "🚀 Фантастика (За рік)", url: "https://api.trakt.tv/shows/watched/yearly?genres=anime,science-fiction&countries=jp,kr&years=" + yearRangeOneYear + "&limit=100" },
            { title: "🧙‍♂️ Фентезі (За рік)", url: "https://api.trakt.tv/shows/watched/yearly?genres=anime,fantasy&countries=jp,kr&years=" + yearRangeOneYear + "&limit=100" },
            { title: "🔪 Трилери (За рік)", url: "https://api.trakt.tv/shows/watched/yearly?genres=anime,thriller&countries=jp,kr&years=" + yearRangeOneYear + "&limit=100" },
            { title: "🔎 Детективи (За рік)", url: "https://api.trakt.tv/shows/watched/yearly?genres=anime,mystery&countries=jp,kr&years=" + yearRangeOneYear + "&limit=100" },
            { title: "😱 Жахи (За рік)", url: "https://api.trakt.tv/shows/watched/yearly?genres=anime,horror&countries=jp,kr&years=" + yearRangeOneYear + "&limit=100" },
            { title: "😂 Комедії (За рік)", url: "https://api.trakt.tv/shows/watched/yearly?genres=anime,comedy&countries=jp,kr&years=" + yearRangeOneYear + "&limit=100" },
            { title: "🎭 Драми (За рік)", url: "https://api.trakt.tv/shows/watched/yearly?genres=anime,drama&countries=jp,kr&years=" + yearRangeOneYear + "&limit=100" },
            { title: "💖 Романтика (За рік)", url: "https://api.trakt.tv/shows/watched/yearly?genres=anime,romance&countries=jp,kr&years=" + yearRangeOneYear + "&limit=100" },
            { title: "🚨 Кримінал (За рік)", url: "https://api.trakt.tv/shows/watched/yearly?genres=anime,crime&countries=jp,kr&years=" + yearRangeOneYear + "&limit=100" },
            { title: "🎼 Музичні (За рік)", url: "https://api.trakt.tv/shows/watched/yearly?genres=anime,music&countries=jp,kr&years=" + yearRangeOneYear + "&limit=100" },
            { title: "⚔️ Військові (За рік)", url: "https://api.trakt.tv/shows/watched/yearly?genres=anime,war&countries=jp,kr&years=" + yearRangeOneYear + "&limit=100" },
            { title: "👨‍👩‍👧 Сімейні (За рік)", url: "https://api.trakt.tv/shows/watched/yearly?genres=anime,family&countries=jp,kr&years=" + yearRangeOneYear + "&limit=100" }
        ]
    };
    ...
    function TraktAnimeTvMain(object) {
            ...
            status.onComplite = function () {
                ...
                Object.keys(status.data).sort(function (a, b) { return a - b; }).forEach(function (key) {
                    ...
                    if (data && data.results && data.results.length) {
                        ...
                        // Беремо перші 20 повністю відфільтрованих карток для головної смуги
                        ...
                        fulldata.push({
                            ...
                            url: cat.url,
                            more: true // Кнопка "Показати більше" активна
                        });
                    }
                });
        ...
        // Клік на "Показати більше" — залишаємо limit=100 для сітки з пагінацією
